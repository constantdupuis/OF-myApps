...
public:
    ...
    {
        setup_grid(cols, rows, width, height, posInCell);
    }
...
private:
        ...
        glm::vec2 posInCell = glm::vec2(0.5f, 0.5f))
    {
        ...
        float cellw = width_ / cols_;
        float cellh = height_ / rows_;

        
        cout << "ofxValueGrid::setup_grid\n";
        cout << "Grid (" << cols_ << "x" << rows_ << ")\n";
        cout << "Grid width " << width_ << "\n";
        cout << "Grid height " << height_ << "\n";
        cout << "Grid cell width " << cellw << "\n";
        cout << "Grid cell height " << cellh << "\n\n";
...
typedef ofxValueGrid<ofxValueGridCell> ofxBasicValueGrid;
