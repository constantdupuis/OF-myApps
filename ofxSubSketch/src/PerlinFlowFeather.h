...
class PerlinFlowFeather : public SubSketchBase
{
public:
    ///
    /// \brief setup
...
private:
    ...
    void drawUI()
    {
        gui.begin();
        {
            ...
            ImGui::SliderFloat("animation speed", &animationSpeed_, 0.0f, 5.0f);
            ...
            ImGui::Checkbox("in color", &in_color_);
            ImGui::Checkbox("use ellipse", &use_ellipse_);
